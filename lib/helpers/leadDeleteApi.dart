...
Future<http.Response> deleteLead(int id) async {
  var headers = {
  ...
  var url = Uri.parse('https://testcrm.thesuperstarshop.com/api/v1/leads/$id');
  ...
  if (response.statusCode == 200) {
    ...
    print('Failed to delete lead: ${response.reasonPhrase}');
  }
