        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                    onPressed: () {
                      Navigator.pushNamed(context, '/addPurchaseOrder');
                    },
                    icon: const Icon(
                    ...
                    child: Card(
                      ...
                      child: Container(
                        ...
                        child: Column(children: [
                          ...
                          ListTile(
                            title: const Text('Total Purchase Orders Amount'),
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: DataTable(
                          columns: const [
                            ...
                            DataColumn(
                                label: Text('Purchase order issued date')),
                            DataColumn(
                                label: Text('Estimated time of arrival')),
