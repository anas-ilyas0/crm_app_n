...
class ClientProjectsReport extends StatefulWidget {
  const ClientProjectsReport({super.key});

  @override
  State<ClientProjectsReport> createState() => _ClientProjectsReportState();
}

class _ClientProjectsReportState extends State<ClientProjectsReport> {
  //DateTime selectedDate = DateTime.now();
  DateTimeRange dateRange =
      DateTimeRange(start: DateTime.now(), end: DateTime.now());
  String date = '';
  List<String> dates = ['Created date', 'Start date', 'Due date'];
  @override
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 25, child: Text('Select')),
